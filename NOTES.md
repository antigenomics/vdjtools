# NOTES.md — vdjtools v2 phase log (archive)

The completed-work narrative distilled out of `CLAUDE.md` on 2026-08-05: every DONE item of Phase 1
(the native V(D)J model engine) and the AS/B27 motif campaign, verbatim. `CLAUDE.md` keeps the
working rules, invariants, and live TODOs; `ROADMAP.md` has the phase plan and `SOURCES.md` the data
provenance and numbers of record.
