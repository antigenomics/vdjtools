...
| 6b | `feature/biomarker-cooccurrence` | Full association framework (Fisher / χ² / Bayesian / Beta-Binomial BF / permutation; binary / per-HLA-allele / Cochran–Mantel–Haenszel stratified conditions) + feature-vs-feature **co-occurrence** (α-β pairing, same-chain co-specificity; θ-lift + Fisher + FDR + Poisson E-value); airr_hip / airr_covid19 / airr_covid19_vacc benchmarks. **v2.7.0** | **in progress** |
